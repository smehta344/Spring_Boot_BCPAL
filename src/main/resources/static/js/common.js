...
$(document).ready(function(){
    ...
    $("#contactSubmit").click(function(){  
    	...
    	var engg_leader = $("#engg_leader").val();
        ...
        var url = urlForServer+"/addplan";
       
		var datastr = '{"date":"'+date+'","location":"'+location+'","engg_leader":"'+engg_leader+'","milestone":"'+milestone+'","project":"'+project+'","account":"'+account+'","proj_status":"'+proj_status+'","challenges":"'+challenges+'","teamSize":"'+teamSize+'","teamLogged":"'+teamLogged+'","mitigation":"'+mitigation+'"}';
		alert(datastr);
		console.log(datastr);
		$.ajax({
